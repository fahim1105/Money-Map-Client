...
const Footer = () => {
  return (
    ...
    >
      {/* Subscribe Bar */}
      <div className="bg-primary rounded-t-2xl w-[90%] md:w-[80%] mx-auto flex flex-col md:flex-row items-center justify-between px-6 py-5 shadow-lg -translate-y-10 relative z-20">
        <h3 className="text-neutral font-semibold text-lg mb-3 md:mb-0">
        ...
        >
          <div className="flex items-center bg-base-100 rounded-full overflow-hidden">
            <input
              ...
              required
              className="flex-grow px-4 py-2 text-neutral focus:outline-none"
            />
            <button
              type="submit"
