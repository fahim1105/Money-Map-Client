...
const Extra = () => {
    return (
        <motion.footer
            ...
            className="mt-16 p-6 sm:p-8 bg-white/10 backdrop-blur-2xl w-[95%] max-w-7xl mx-auto rounded-3xl shadow-2xl border border-white/20"
        >
            {/* Wrapper */}
            <div className="flex flex-col lg:flex-row lg:justify-between gap-12">
                ...
                <div className="flex items-start gap-4 max-w-xl">
                    <div className="p-3 sm:p-4 bg-green-400/20 rounded-2xl border border-green-300/20">
                        <Users className="w-8 h-8 sm:w-10 sm:h-10 text-green-300" />
                    </div>
                    <div>
                        <h2 className="text-2xl sm:text-3xl text-white font-bold leading-snug">
