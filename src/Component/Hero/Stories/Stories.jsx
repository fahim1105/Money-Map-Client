        ...
        <section className="bg-transparent py-20 px-4 lg:px-12">
            <div className="max-w-7xl mx-auto text-center">
                <motion.h2
                    ...
                    className="text-5xl md:text-4xl font-bold mb-4 text-primary-content"
                >
                    Success Stories
                </motion.h2>
                ...
                <motion.p
                    ...
                    className="text-primary-content max-w-2xl mx-auto mb-12"
                >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {testimonials.map((testi, index) => (
                        <motion.div
                            ...
                            className="bg-base-100/90 p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 text-center"
                        >
                            <img
                                src={testi.avatar}
                                alt={testi.name}
                                className="w-20 h-20 mx-auto rounded-full mb-4 object-cover border-4 border-primary-content"
                            />
                            <h3 className="text-xl font-semibold text-primary">{testi.name}</h3>
                            <p className="text-sm text-base-200 mb-4">{testi.role}</p>
